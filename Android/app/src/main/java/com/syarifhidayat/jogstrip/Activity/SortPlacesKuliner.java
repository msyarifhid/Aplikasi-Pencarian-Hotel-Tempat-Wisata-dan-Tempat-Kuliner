...
public class SortPlacesKuliner implements Comparator<TempatKuliners> {
    LatLng currentLoc;

    public SortPlacesKuliner(LatLng current){
        currentLoc = current;
    }
    @Override
    public int compare(final TempatKuliners place1, final TempatKuliners place2) {
