...
public class SortPlacesWisata implements Comparator<TempatWisatas> {
    LatLng currentLoc;

    public SortPlacesWisata(LatLng current){
        currentLoc = current;
    }
    @Override
    public int compare(final TempatWisatas place1, final TempatWisatas place2) {
