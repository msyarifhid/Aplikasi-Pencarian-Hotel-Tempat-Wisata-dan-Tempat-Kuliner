...
public class AdapterTerdekatHotel extends RecyclerView.Adapter<AdapterTerdekatHotel.ViewwHolder> {
    ...
    public AdapterTerdekatHotel(Context context, List<BasePlace> listBasePlace) {
    ...
    public ViewwHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ViewwHolder(LayoutInflater.from(context).inflate(R.layout.layout_item_terdekat_hotel, parent, false));
    ...
    public void onBindViewHolder(@NonNull ViewwHolder holder, int position) {
        ...
        holder.tv_jarakTerdekatHotel.setText(new DecimalFormat("#.##").format(bP.getJarakTerdekat())+ " KM");
        holder.tv_tempatTerdekatHotel.setText(bP.getNamaTerdekat());

        if (bP.getJenis().equals("hotel")){
            holder.icTerdekatHotel.setColorFilter(Color.RED, PorterDuff.Mode.SRC_ATOP);
        }else if(bP.getJenis().equals("tempat_wisata")){
            holder.icTerdekatHotel.setColorFilter(Color.GREEN, PorterDuff.Mode.SRC_ATOP);
        }else if(bP.getJenis().equals("tempat_kuliner")){
            holder.icTerdekatHotel.setColorFilter(Color.YELLOW, PorterDuff.Mode.SRC_ATOP);
        }

        //click to deskripsiTerdekat
        holder.ly_itemTerdekatHotel.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    static class ViewwHolder extends RecyclerView.ViewHolder {
        ...
        ImageView icTerdekatHotel;
        TextView tv_tempatTerdekatHotel, tv_jarakTerdekatHotel;
        LinearLayout ly_itemTerdekatHotel;


        public ViewwHolder(View itemView) {
            super(itemView);

            icTerdekatHotel = itemView.findViewById(R.id.icTerdekatHotel);
            tv_tempatTerdekatHotel = itemView.findViewById(R.id.tv_tempatTerdekatHotel);
            tv_jarakTerdekatHotel = itemView.findViewById(R.id.tv_jarakTerdekatHotel);
            ly_itemTerdekatHotel = itemView.findViewById(R.id.ly_itemTerdekatHotel);
        }
    }
